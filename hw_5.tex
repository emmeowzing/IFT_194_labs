...
\subsection{Ex 9.3}
In this example we're tasked with drawing a UML class diagram showing an Inheritance hierarchy containing classes that represent different types of cars. See figure
\subsection{Ex 9.7}
In this example we're tasked with drawing a UML class diagram that shows an inheritance hierarchy containing classees that represent different types of payment. See figure
\subsection{Ex 9.8}
In this example I've written some code 
\subsection{Ex 10.1}
\subsection{Ex 10.2}
\subsection{Ex 10.3}
\section{Exploring Inheritance}
\end{document}
