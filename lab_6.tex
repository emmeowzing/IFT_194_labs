...
For this section we're given a class \texttt{CountLetters} (cf. \hyperref[fig:one]{Figure 1}) that reads a word from the user and prints the number of occurrences of each letter in the word.
\iftcodefigure{fig:one}{CountLetters.java}{%
  /home/brandon/eclipse-workspace/ift_194_labs/src/lab_6/CountLetters.java}
