...
\begin{enumerate}
  \item Class constructors are special methods that are called when the \texttt{new} operator is used to create a new instance of a class.
  ...
  \item Access modifiers, which include \texttt{public} and \texttt{private}, among others, are used to determine what 
\end{enumerate}
